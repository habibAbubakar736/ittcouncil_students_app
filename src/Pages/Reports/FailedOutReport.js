...
const FailedOutReport = () => {
    ...
    const GetStudentsProfile = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`${apiURL}Students/GetFailedOutSubjects`, { params: { page: 1, limit: 10, student_id }, headers });
        ...
        <div className="main-content">
            <div className="page-content">
                <div className="container-fluid">
                    <br />
                    <PageTitle title={"failedout Report"} primary={"Dashboard"} />

                    <div className="card">
                        <div className="card-header text-center" style={{ background: primaryColor }}>
                            <h5 className='card-title mb-0 text-white'>Fail Out Subjects</h5>
                        </div>
...
export default FailedOutReport;
